...
use CondorcetVote\CefWriter\Exception\{InvalidUtf8Exception, InvalidValueException, ReservedCharacterException};
...
})->throws(InvalidValueException::class, 'null byte');
...
])->throws(InvalidUtf8Exception::class, 'invalid UTF-8');
